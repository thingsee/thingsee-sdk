 ...
 * MBEDTLS_SSL_MAX_OUT_CONTENT_LEN setting.
 */
 ...
 * size than maximum specified for protocol. This setting allows reducing
 * RAM usage at expense of additional networking overhead.
 *
 * Setting to '0' will select protocol default maximum fragment
 * length which is 16 KiB (16384 bytes).
 */
#if !defined(MBEDTLS_SSL_MAX_OUT_CONTENT_LEN)
#define MBEDTLS_SSL_MAX_OUT_CONTENT_LEN     MBEDTLS_SSL_MAX_CONTENT_LEN
#endif
